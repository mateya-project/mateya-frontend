      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: const <Widget>[
            MateyaSkeletonBlock(height: 28, width: 160),
            SizedBox(height: 10),
            MateyaSkeletonBlock(height: 16, width: 96),
            SizedBox(height: 16),
            MateyaSkeletonBlock(height: 52),
            SizedBox(height: 14),
            MateyaSkeletonBlock(height: 44),
            SizedBox(height: 16),
            Expanded(child: MateyaMapSkeleton()),
            SizedBox(height: 16),
            MateyaSkeletonBlock(height: 108),
          ],
        ),
      ),
    );
